...
function setSensorValues() {
    ...
    $.ajax({
        ...
        success: function(response) {
            //*
            $("#currentInfo_label").html("Real-Time Data (" + response.update_date + " " + response.update_time + ")");
            ...
            // $("#temperature_condition_value").html(status_good);
            //$("#humidity_condition_value").html(status_bad_up);
            //$("#co2_condition_value").html(status_bad_down);
            // $("#light_condition_value").html(status_good);
            //$("#ec_condition_value").html(status_bad_up);
            //$("#ph_condition_value").html(status_bad_down);
            //*/

            $('#VPDHD_temp').html("Temperature : " + dryTemp.toFixed(0) + " ℃");
            $('#VPDHD_humi').html("Humidity : " + humidity.toFixed(0) + " %");
...
function changeRangeValue() {
    $(document).on('input', '#VPDHD_rangeTemp', function() {
        $('#VPDHD_temp').html("Temperature : " + $(this).val() + " ℃");
    ...
    $(document).on('input', '#VPDHD_rangeHumi', function() {
        $('#VPDHD_humi').html("Humidity : " + $(this).val() + " %");
